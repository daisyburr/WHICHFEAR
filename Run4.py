...
data_path = "Run4_onsets"+str(subj_id)+".csv";
...
n_IDs=6;
n_blocks=6;
ForYou_list = ["Face 3-1.bmp", "Face 3-2.bmp", "Face 3-3.bmp", "Face 3-4.bmp", "Face 3-5.bmp", "Face 3-6.bmp"];
OfYou_list =["Face 4-1.bmp", "Face 4-2.bmp", "Face 4-3.bmp", "Face 4-4.bmp", "Face 4-5.bmp", "Face 4-6.bmp"];
FromYou_list = ["Face 2-1.bmp", "Face 2-2.bmp", "Face 2-3.bmp", "Face 2-4.bmp", "Face 2-5.bmp", "Face 2-6.bmp"];
...
for i in range(0,n_IDs):
    ...
    for j in range(0,n_IDs):
        ...
        filename2="ForYou_Stim/"+ ForYou_list[j]
...
for i in range(0,n_IDs):
    ...
    for j in range(0,n_IDs):
        ...
        filename3="FromYou_Stim/"+ FromYou_list[j]
        img = psychopy.visual.ImageStim(
            win=win,
            image=filename3,
            units="pix"
...
#----Block 3 of 6 "OF YOU"----
#
#Show first fixation for 13.1 seconds
fixation_text.draw()
win.flip()
...
psychopy.core.wait(2)
#
#Show fixation after instructions for 2.9 seconds
fixation_text.draw()
win.flip()
...
for i in range(0,n_IDs):
    ...
    for j in range(0,n_IDs):
        ...
        filename1="OfYou_Stim/"+ OfYou_list[j]
        img = psychopy.visual.ImageStim(
            win=win,
            image=filename1,
            units="pix"
...
#
#Show initial fixation for 13.5 seconds
fixation_text.draw()
win.flip()
...
#----Block 5 of 6 "Of You"----
#
#Show initial fixation for 12.5 seconds
fixation_text.draw()
win.flip()
psychopy.core.wait(12.5)
#
#Show instructions for 2 seconds
ofyou_text.draw()
win.flip()
psychopy.core.wait(2)
#
#Show fixation after instructions for 3.5 seconds
fixation_text.draw()
win.flip()
psychopy.core.wait(3.5)
#
#Begin picture loop
for i in range(0,n_IDs):
    shuffle(OfYou_list)
