...
#Unlabeled Trial Run 1 Version 2
#---------------------------------------------------------
...
data_path = "UL_Run1V2_onsets"+str(subj_id)+".csv";
...
n_IDs=6;
n_blocks=4;
Unlabeled_list = ["Face 4-1.bmp", "Face 4-2.bmp", "Face 4-3.bmp", "Face 4-4.bmp", "Face 4-5.bmp", "Face 4-6.bmp"];
...
for i in range(0,n_blocks):
    ...
    for j in range(0,n_IDs):
        ...
        for k in range(0,n_IDs):
            ...
            filename="ULV2_Stim/"+ Unlabeled_list[k]
            print filename
